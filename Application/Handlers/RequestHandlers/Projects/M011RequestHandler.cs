...
public class M011RequestHandler : IRequestHandler<M011Request, IResult>
{
    private readonly IRepository<Project> _repository;
    private readonly IRepository<Tag> _tagRepository;

    public M011RequestHandler(IRepository<Project> repository, IRepository<Tag> tagRepository)
    {
        _repository = repository;
        _tagRepository = tagRepository;
    }
    public async Task<IResult> Handle(M011Request request, CancellationToken cancellationToken)
    {
