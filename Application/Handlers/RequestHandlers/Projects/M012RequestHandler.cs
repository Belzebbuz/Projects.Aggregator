...
public class M012RequestHandler : IRequestHandler<M012Request, IResult>
{
    private readonly IRepository<Project> _repository;
    private readonly IRepository<Tag> _tagRepository;

    public M012RequestHandler(IRepository<Project> repository, IRepository<Tag> tagRepository)
    {
        _repository = repository;
        _tagRepository = tagRepository;
    }
    public async Task<IResult> Handle(M012Request request, CancellationToken cancellationToken)
    {
