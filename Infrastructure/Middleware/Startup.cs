...
{
    internal static IServiceCollection AddPaginationMiddleware(this IServiceCollection services)
        => services.AddScoped<PaginationMiddleware>();
    internal static IApplicationBuilder UsePaginationMiddleware(this IApplicationBuilder app)
